...
open class Option {
    ...
    public init(shortFlag: String, longFlag: String, required: Bool, defaultValue:String?, helpMessage: String) {
...
open class BoolOption: Option {
    ...
    public init(shortFlag: String, longFlag: String, defaultValue: String?, helpMessage: String) {
        super.init(shortFlag: shortFlag, longFlag: longFlag, required: false, defaultValue: defaultValue, helpMessage: helpMessage)
    }
...
open class EnumOption<T:RawRepresentable>: Option where T.RawValue == String {
    ...
    override public init(shortFlag: String, longFlag: String, required: Bool, defaultValue: String?, helpMessage: String) {
        super.init(shortFlag: shortFlag, longFlag: longFlag, required: required, defaultValue: defaultValue, helpMessage: helpMessage)
    }
