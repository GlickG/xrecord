...
let list = BoolOption(shortFlag: "l", longFlag: "list", defaultValue: nil,
                      helpMessage: "List available capture devices.")
let name = StringOption(shortFlag: "n", longFlag: "name", required: false, defaultValue: "iPhone",
                        helpMessage: "Device Name.")
let id = StringOption(shortFlag: "i", longFlag: "id", required: false, defaultValue: nil,
                      helpMessage: "Device ID.")
let outFile = StringOption(shortFlag: "o", longFlag: "out", required: false, defaultValue: "./recording.mp4",
                           helpMessage: "Output File.")
let force = BoolOption(shortFlag: "f", longFlag: "force", defaultValue: nil,
                       helpMessage: "Overwrite existing files.")
let qt = BoolOption(shortFlag: "q", longFlag: "quicktime", defaultValue: "true",
                    helpMessage: "Include QuickTime devices (necessary for iOS recording).")
let time = IntOption(shortFlag: "t", longFlag: "time", required: false, defaultValue: nil,
                     helpMessage: "Recording time in seconds (records until stopped if not specified).")
let quality = StringOption(shortFlag: "u", longFlag: "quality", required: false, defaultValue: nil,
                           helpMessage: "Recording quality (low, medium, high, photo - defaults to high)")
let debug = BoolOption(shortFlag: "d", longFlag: "debug", defaultValue: nil,
                       helpMessage: "Display debugging info to stderr.")
let help = BoolOption(shortFlag: "h", longFlag: "help", defaultValue: nil,
